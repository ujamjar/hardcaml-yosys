...
(* OASIS_START *)
(* DO NOT EDIT (digest: e88b685978a928469519ffb72f2cf2c9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml";
          synopsis = "Hardware in OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Design, simulate, analyse and transform RTL level hardware designs."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ks\tM\174\235\204\226\194XvQ\\\212\197\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
