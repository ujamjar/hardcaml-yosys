...
(* OASIS_START *)
(* DO NOT EDIT (digest: a4ffaffe7bdbc82da8726d307c003166) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-yosys";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Use yosys to convert a Verilog design into JSON then use this library to load it as a HardCaml design."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "hardcaml-yosys";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "convert.ml"});
               Executable
                 ({
                     cs_name = "mram";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "mram.ml"});
               Executable
                 ({
                     cs_name = "wrram";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "wrram.ml"});
               Doc
                 ({
                     cs_name = "HardCamlYosys";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "HardCaml documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\143\152\173f=\183W\028\165\209X[\246\1271\235";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
