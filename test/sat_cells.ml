...
module Test(C : HardCamlYosys.Techlib.Proof.Cells)(P : sig
  val params : int C.P.t list
end) = struct

  module Proof = HardCamlYosys.Techlib.Proof.Make(C)
...
module Op1 = Test(HardCamlYosys.Techlib.Simlib.Op1)(struct
  open HardCamlYosys.Techlib.Simlib.Op1.P 
...
module Op2 = Test(HardCamlYosys.Techlib.Simlib.Op2)(struct
  open HardCamlYosys.Techlib.Simlib.Op2.P 
  let sgn p = [ 
...
module Fa = Test(HardCamlYosys.Techlib.Simlib.Fa)(struct
  open HardCamlYosys.Techlib.Simlib.Fa.P 
  let params = Array.to_list @@ Array.init 9 (fun width -> { width=width+1 })
end)

(* XXX not working *)
module Lcu = Test(HardCamlYosys.Techlib.Simlib.Lcu)(struct
  open HardCamlYosys.Techlib.Simlib.Lcu.P 
  let params = Array.to_list @@ Array.init 9 (fun width -> { width=width+1 })
end)

module Slice = Test(HardCamlYosys.Techlib.Simlib.Slice)(struct
  open HardCamlYosys.Techlib.Simlib.Slice.P 
  let rnd _ = { offset = rnd 0 10; a_width = rnd 1 10; y_width = rnd 1 10 }
  let params = Array.to_list @@ Array.init n_random_params rnd;
end)

module Concat = Test(HardCamlYosys.Techlib.Simlib.Concat)(struct
  open HardCamlYosys.Techlib.Simlib.Concat.P 
  let rnd _ = { a_width = rnd 1 10; b_width = rnd 1 10 }
  let params = Array.to_list @@ Array.init n_random_params rnd;
end)

module Mux = Test(HardCamlYosys.Techlib.Simlib.Mux)(struct
  open HardCamlYosys.Techlib.Simlib.Mux.P 
  let params = Array.to_list @@ Array.init 9 (fun width -> { width=width+1 })
end)

module Pmux = Test(HardCamlYosys.Techlib.Simlib.Pmux)(struct
  open HardCamlYosys.Techlib.Simlib.Pmux.P 
  let rnd _ = { width = rnd 1 10; s_width = rnd 1 10 }
  let params = Array.to_list @@ Array.init n_random_params rnd;
end)

module Lut = Test(HardCamlYosys.Techlib.Simlib.Lut)(struct
  open HardCamlYosys.Techlib.Simlib.Lut.P 
  let rnd _ = 
